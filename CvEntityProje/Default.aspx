...
<!-- //custom-theme -->
<link href="emre/web/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
<script src="emre/web/js/jquery-2.2.3.min.js"></script> 
<!-- //js -->
<!-- font-awesome-icons -->
<link href="emre/web/css/font-awesome.css" rel="stylesheet"> 
<!-- //font-awesome-icons --> 
<link href="emre/web/css/lightcase.css" rel="stylesheet" type="text/css" />
...
<body>
			...
			<div class="w3layouts_main_grid_left">	
				<div class="w3_main_grid_left_grid">	
					...
					<div class="w3l_figure">
						<img src="emre/web/images/1.png" alt=" " />
					</div>
	...
	<script src="emre/web/js/easyResponsiveTabs.js"></script>
	...
	<!-- light-case -->
		<script src="emre/web/js/lightcase.js"></script>
		<script src="emre/web/js/jquery.events.touch.js"></script>
		<script>
			$('.showcase').lightcase();
		</script>
	<!-- //light-case -->
